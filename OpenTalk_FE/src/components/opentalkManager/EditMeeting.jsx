...
// Nhận meeting prop hoặc fetch bằng id
function EditMeeting({ meeting: propMeeting }) {
  // Lấy id từ URL nếu cần
  const { id } = useParams();

  // Khởi tạo từ prop hoặc mock data
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // TODO: Call API update tại đây
    alert("Meeting updated:\n" + JSON.stringify(form, null, 2));
    navigate(-1); // Quay lại sau khi lưu
  };
    ...
    <div className="addmeeting-bg-enterprise">
      <div className="addmeeting-container py-3">
        <div className="d-flex align-items-center gap-2 mb-1">
          ...
          <span className="fw-semibold fs-5 back-text" style={{ cursor: "pointer" }} onClick={() => navigate(-2)}>
            Back
          </span>
        </div>
