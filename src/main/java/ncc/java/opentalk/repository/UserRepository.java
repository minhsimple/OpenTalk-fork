...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT u FROM User u WHERE u.isEnabled = true AND (u.lastHosted IS NULL OR YEAR(u.lastHosted) < :currentYear)")
    List<User> findEligibleUsers(@Param("currentYear") int currentYear);
